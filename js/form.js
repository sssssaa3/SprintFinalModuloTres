document.addEventListener("DOMContentLoaded", () => {
  ...
  inputName.addEventListener("input", (e) => {
    changeStateInput(inputName, (value) => value.length >= 1, "inputName")

  })

  inputLastName.addEventListener("input", (e) => {
    changeStateInput(inputLastName, (value) => value.length >= 1, "inputLastName")
  })

  inputMessage.addEventListener("input", (e) => {
    changeStateInput(inputMessage, (value) => value.length >= 1, "inputMessage")
  })
  ...
  form.addEventListener("submit", (event) => {
    ...
    if (formIsValid.inputLastName && formIsValid.inputMessage && formIsValid.inputName) {
      resetForm()
      modalEmail.show()
    }
